...
const getChampionFullImagePathByName = name => {
  return (
    "/dragontail-10.5.1/10.5.1/img/champion/" +
    getChampionInfoByName(name).image.full
  );
};

exports.getChampionFullImagePathByName = getChampionFullImagePathByName;

const getItemFullImagePathById = id => {
  return "/dragontail-10.5.1/10.5.1/img/item/" + id + ".png";
};

exports.getItemFullImagePathById = getItemFullImagePathById;
